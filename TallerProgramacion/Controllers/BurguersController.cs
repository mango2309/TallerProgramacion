...
namespace TallerProgramacion.Controllers
{
    public class BurguersController : Controller
    {
        private readonly TallerProgramacionContext _context;

        public BurguersController(TallerProgramacionContext context)
        {
            _context = context;
        }
